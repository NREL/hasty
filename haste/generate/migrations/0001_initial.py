    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('heating_coil_type', models.CharField(choices=[(1, 'Heating Coil 1'), (2, 'Heating Coil 2'), ('None', 'None')], max_length=100)),
                ('cooling_coil_type', models.CharField(choices=[(1, 'Heating Coil 1'), (2, 'Heating Coil 2'), ('None', 'None')], max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='Site',
