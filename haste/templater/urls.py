...
urlpatterns = [
    ...
    path('fault/haystack', views.HaystackCreateFaultTemplateView.as_view(), name='templater.haystack.create_fault_template'),
    path('fault/brick', views.BrickCreateFaultTemplateView.as_view(), name='templater.brick.create_fault_template'),
]
